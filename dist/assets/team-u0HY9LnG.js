import{k as T,s as w,m as f,a as u,G as d,S as A,l as z,i as P,n as F,d as ie}from"./dashboard-bIYtn9Go.js";import{c as ne}from"./color-swatches-CGsQth5R.js";import{r as L,t as j,e as ae}from"./swipe-close-Dnpxvj1C.js";import{I as C}from"./icons-DATqSsmT.js";let B=null,_=new Date().getFullYear(),g={},y=new Set,x=[];const p=e=>e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"";function S(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const k={close:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',edit:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>',tasks:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></svg>',key:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/></svg>',role:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',mail:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/></svg>',phone:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',calendar:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>',star:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',sun:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>',hourglass:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 22h14"/><path d="M5 2h14"/><path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22"/><path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"/></svg>',plus:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',trash:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',link:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>',shield:'<svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>'},D={cdi:"CDI",cdd:"CDD",independant:"Indépendant",stagiaire:"Stagiaire",interim:"Intérim"},G={conge:"Congé",maladie:"Maladie",formation:"Formation",recuperation:"Récup."};function J(e){if(!e||e.length===0)return{label:"—",detail:""};const t=e.length;if(t===7)return{label:"7/7",detail:""};const i=["lun","mar","mer","jeu","ven","sam","dim"],n=[];for(let s=0;s<7;s++)e.includes(s)||n.push(i[s]);if(t===5&&!e.includes(5)&&!e.includes(6))return{label:"Temps plein",detail:""};const o=n.length<=3?n.join(", ")+" off":"";return{label:`${t}/7`,detail:o}}function se(e){return e<=0?"danger":e<=5?"warn":"ok"}async function $(){const e=document.getElementById("contentArea");e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{const[t,i]=await Promise.all([fetch("/api/practitioners",{headers:{Authorization:"Bearer "+u.getToken()}}),fetch("/api/calendar/connections",{headers:{Authorization:"Bearer "+u.getToken()}}).catch(()=>({ok:!1}))]),n=await t.json(),s=(i.ok?await i.json():{connections:[]}).connections||[],r=n.practitioners||[],c=f.practitioner.toLowerCase();let l=`<div class="tm-list-header">
      ...
      </div>`,l+="</div>"),e.innerHTML=l}catch(t){e.innerHTML=`<div class="empty" style="color:var(--red)">Erreur: ${p(t.message)}</div>`}}function oe(e){if(!e&&window._businessPlan==="free"&&document.querySelectorAll(".tm-card:not(.tm-add)").length>=1){d.toast("Passez au Pro pour ajouter des praticiens","error");return}const t={Authorization:"Bearer "+u.getToken()};e?Promise.all([fetch("/api/practitioners",{headers:t}).then(i=>i.json()),fetch("/api/services",{headers:t}).then(i=>i.json())]).then(([i,n])=>{x=(n.services||[]).filter(o=>o.is_active!==!1),q(i.practitioners.find(o=>o.id===e))}):fetch("/api/services",{headers:t}).then(i=>i.json()).then(i=>{x=(i.services||[]).filter(n=>n.is_active!==!1),q(null)})}function q(e){B=null,_=new Date().getFullYear(),y=new Set,e&&x.forEach(a=>{a.practitioner_ids&&a.practitioner_ids.includes(e.id)&&y.add(a.id)});const t=!!e;f.practitioner.toLowerCase();const i=e?.color||"#0D7377",n=e?.display_name?.split(" ").map(a=>a[0]).join("").toUpperCase().slice(0,2)||"??",o=e?.photo_url?`<img src="${p(e.photo_url)}" alt="${p(e.display_name)}" style="width:100%;height:100%;object-fit:cover">`:n,s=e?p(e.display_name):"Nouveau "+f.practitioner;let r=`<div id="teamModalOverlay" class="m-overlay open">
  ...
  </div></div>`;document.body.insertAdjacentHTML("beforeend",r);const c=document.getElementById("teamModalOverlay");z(c,{noBackdropClose:!0}),j(c,()=>E()),ae(c.querySelector(".m-dialog"),()=>E()),P(c),document.getElementById("p_color_wrap").innerHTML=ne("p_color",e?.color||"#1E3A8A",!1);const l=document.getElementById("p_color");if(l&&l.addEventListener("change",()=>{const a=l.value||"#0D7377",v=document.getElementById("tmHeaderBg"),h=document.getElementById("tmAvatar");v&&(v.style.background=`linear-gradient(135deg,${a} 0%,${a}AA 60%,${a}55 100%)`),h&&(h.style.background=`linear-gradient(135deg,${a},${a}CC)`)}),e?.id,t)window.loadPracCalSync&&window.loadPracCalSync(e.id),Y(e.id,_),U(e.id);else{g={};for(let a=0;a<7;a++)g[a]=[]}}async function E(){L(),await T("teamModalOverlay")}function re(e){document.querySelectorAll("#teamModalOverlay .m-tab").forEach(t=>{t.classList.toggle("active",t.dataset.tab===e)}),document.querySelectorAll("#teamModalOverlay .m-panel").forEach(t=>t.classList.remove("active")),document.getElementById("team-panel-"+e)?.classList.add("active")}function I(){if(x.length===0)return`<div style="font-size:.78rem;color:var(--text-4);padding:12px 0">Aucune prestation créée. <a href="#" onclick="event.preventDefault();window.loadSection&&window.loadSection('services')" style="color:var(--primary)">Créer des prestations</a></div>`;const e={},t=[];x.forEach(s=>{const r=s.category||"Sans catégorie";e[r]||(e[r]=[],t.push(r)),e[r].push(s)});const i=x.length,n=y.size;let o=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
    ...
    <button class="m-btn m-btn-ghost" style="font-size:.7rem;padding:4px 10px" onclick="teamToggleAllServices()">${n===i?"Tout désélectionner":"Tout sélectionner"}</button>
      ...
      </label>`,r.forEach(a=>{const v=y.has(a.id),h=a.price_cents?(a.price_cents/100).toFixed(2).replace(".",",").replace(",00","")+"€":"";o+=`<label class="svc-assign-item${v?" checked":""}" onclick="event.preventDefault();teamToggleService('${a.id}')">
      ...
      </label>`}),o+="</div>"}),o}function le(e){y.has(e)?y.delete(e):y.add(e),document.getElementById("tm_services_list").innerHTML=I()}function ce(e){const t=x.filter(n=>(n.category||"Sans catégorie")===e),i=t.every(n=>y.has(n.id));t.forEach(n=>{i?y.delete(n.id):y.add(n.id)}),document.getElementById("tm_services_list").innerHTML=I()}function de(){y.size===x.length?y.clear():x.forEach(t=>y.add(t.id)),document.getElementById("tm_services_list").innerHTML=I()}const O=["Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi","Dimanche"];async function U(e){try{const o=((await(await fetch(`/api/availabilities?practitioner_id=${e}`,{headers:{Authorization:"Bearer "+u.getToken()}})).json()).availabilities||{})[e];g={};for(let s=0;s<7;s++)g[s]=(o?.schedule?.[s]||[]).map(r=>({start_time:r.start_time,end_time:r.end_time}));document.getElementById("tm_schedule_editor").innerHTML=M()}catch(t){document.getElementById("tm_schedule_editor").innerHTML=`<div style="color:var(--red);font-size:.82rem">Erreur: ${p(t.message)}</div>`}}function M(){const e=[];for(let n=0;n<7;n++)g[n]&&g[n].length>0&&e.push(n);const t=J(e);let i=`<div style="font-size:.82rem;font-weight:600;margin-bottom:10px;display:flex;align-items:center;gap:8px">
    ...
    <thead><tr><th>Type</th><th>Quota</th><th>Pris</th><th>Solde</th></tr></thead><tbody>`;return t.forEach(n=>{const o=e?.[n]||{total:0,used:0},s=(o.total||0)-(o.used||0),r=se(s);i+=`<tr>
    ...
    </tr>`}),i+="</tbody></table>",i}async function Y(e,t){_=parseInt(t);try{const n=await(await fetch(`/api/practitioners/${e}/leave-balance?year=${t}`,{headers:{Authorization:"Bearer "+u.getToken()}})).json();document.getElementById("tm_leave_table").innerHTML=Z(n.balances);const o=document.getElementById("tm_recent_abs");n.recent_absences&&n.recent_absences.length>0?o.innerHTML=n.recent_absences.map(s=>{const r=new Date(s.date_from).toLocaleDateString("fr-BE",{day:"numeric",month:"short",timeZone:"Europe/Brussels"}),c=new Date(s.date_to).toLocaleDateString("fr-BE",{day:"numeric",month:"short",timeZone:"Europe/Brussels"});return`<div style="padding:6px 0;border-bottom:1px solid var(--border-light);display:flex;justify-content:space-between;align-items:center">
      ...
      <div class="m-body" style="overflow-y:auto;flex:1">`;v+=`<div class="m-sec"><div class="m-sec-head"><span class="m-sec-title">Tâches en cours (${r.length})</span><span class="m-sec-line"></span></div>`,r.length===0?v+='<div style="font-size:.8rem;color:var(--text-4)">Aucune tâche en cours</div>':r.forEach(m=>{const b=m.booking_start?new Date(m.booking_start).toLocaleDateString("fr-BE",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",timeZone:"Europe/Brussels"}):"";v+=`<div style="padding:8px 0;border-bottom:1px solid var(--border-light);display:flex;gap:10px;align-items:flex-start">
        ...
        </div>`}),a.length>0&&(v+=`<div style="font-size:.72rem;color:var(--text-4);margin-top:8px">${a.length} rappel${a.length>1?"s":""} déjà envoyé${a.length>1?"s":""}</div>`),v+="</div>",v+="</div></div></div>",document.body.insertAdjacentHTML("beforeend",v);const h=document.getElementById("tasksModalOverlay");z(h,{noBackdropClose:!0}),j(h,()=>H())}catch(i){d.toast("Erreur: "+i.message,"error")}}function H(){L(),T("tasksModalOverlay"),document.querySelector(".m-overlay.open")||document.body.classList.remove("has-modal")}async function ke(e,t,i,n,o){try{await fetch(`/api/bookings/${t}/todos/${e}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:"Bearer "+u.getToken()},body:JSON.stringify({is_done:i})}),H(),W(n,o)}catch{d.toast("Erreur","error")}}function $e(e,t){const i=A[F]||A.autre;let n=`<div class="m-overlay open" id="inviteModalOverlay"><div class="m-dialog m-sm">
  ...
  </div></div>`;document.body.insertAdjacentHTML("beforeend",n);const o=document.getElementById("inviteModalOverlay");z(o,{noBackdropClose:!0}),j(o,()=>R())}async function R(){L(),await T("inviteModalOverlay")}function X(){const e="ABCDEFGHJKMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789";let t="";for(let i=0;i<10;i++)t+=e[Math.floor(Math.random()*e.length)];return t}async function we(e){const t=document.getElementById("inv_email").value,i=document.getElementById("inv_pwd").value,n=document.getElementById("inv_role").value;if(!t||!i)return d.toast("Email et mot de passe requis","error");try{const o=await fetch(`/api/practitioners/${e}/invite`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+u.getToken()},body:JSON.stringify({email:t,password:i,role:n})});if(!o.ok)throw new Error((await o.json()).error);document.getElementById("inviteModalOverlay")?._dirtyGuard?.markClean(),R(),d.toast("Compte créé ! Communiquez les identifiants.","success"),$()}catch(o){d.toast("Erreur: "+o.message,"error")}}function Ee(e,t,i){const n=A[F]||A.autre,o=[{value:"owner",label:"Propriétaire / Manager",desc:"Accès complet au dashboard"},{value:"practitioner",label:n.practitioner,desc:"Voit uniquement son propre agenda et ses clients"}];let s=`<div class="m-overlay open" id="roleModalOverlay"><div class="m-dialog m-sm">
    <div class="m-header-simple">
    ...
    <div class="m-bottom">
  ...
  </div></div>`,document.body.insertAdjacentHTML("beforeend",s);const r=document.getElementById("roleModalOverlay");z(r,{noBackdropClose:!0}),j(r,()=>V())}async function V(){L(),await T("roleModalOverlay")}async function Ce(e){const t=document.querySelector('input[name="role_pick"]:checked');if(!t)return d.toast("Sélectionnez un rôle","error");try{const i=await fetch(`/api/practitioners/${e}/role`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:"Bearer "+u.getToken()},body:JSON.stringify({role:t.value})});if(!i.ok)throw new Error((await i.json()).error);document.getElementById("roleModalOverlay")?._dirtyGuard?.markClean(),V(),d.toast("Rôle modifié","success"),$()}catch(i){d.toast("Erreur: "+i.message,"error")}}const N=e=>e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"";async function ee(e){const t=document.getElementById("p_cal_area");if(t)try{const i=await fetch(`/api/calendar/connections?practitioner_id=${e}`,{headers:{Authorization:"Bearer "+u.getToken()}}),o=(i.ok?await i.json():{connections:[]}).connections||[],s=o.find(a=>a.provider==="google"),r=o.find(a=>a.provider==="outlook"),c=o.find(a=>a.provider==="ical");let l='<div style="display:grid;gap:8px">';if(l+=`<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:var(--white);border:1px solid var(--border-light);border-radius:8px">
      ...
      </div>`}t.innerHTML=l}catch{t.innerHTML='<div style="font-size:.78rem;color:var(--text-4)">Impossible de charger les connexions calendrier.</div>'}}async function Te(e,t){try{const i=await u.get(`/api/calendar/${e}/connect?practitioner_id=${t||""}`);i.url?window.location.href=i.url:d.toast("Erreur de connexion","error")}catch(i){d.toast(i.message||"Erreur","error")}}async function Be(e,t,i){const n=t==="google"?"Google Calendar":"Outlook";if(await w("Déconnecter "+n,"Déconnecter "+n+" ?","Déconnecter","danger"))try{await u.delete(`/api/calendar/connections/${e}`),d.toast("Calendrier déconnecté","success"),i&&ee(i)}catch(s){d.toast(s.message||"Erreur","error")}}async function Me(e){try{d.toast("Synchronisation en cours...","info");const t=await u.post(`/api/calendar/connections/${e}/sync`);d.toast("Synchro terminée : "+(t.pushed||0)+" poussés, "+(t.pulled||0)+" récupérés","success")}catch(t){d.toast(t.message||"Erreur synchro","error")}}async function Se(e,t){try{const i=await fetch(`/api/calendar/connections?practitioner_id=${t}`,{headers:{Authorization:"Bearer "+u.getToken()}}),n=i.ok?await i.json():{connections:[]};for(const o of n.connections||[])o.provider!=="ical"&&await u.patch("/api/calendar/connections/"+o.id,{sync_direction:e});d.toast("Direction de synchro mise à jour","success")}catch(i){d.toast(i.message||"Erreur","error")}}async function Ae(e){try{const t=await fetch("/api/calendar/ical/generate",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+u.getToken()},body:JSON.stringify({practitioner_id:e||null})}),i=await t.json();if(!t.ok)throw new Error(i.error||"Erreur");const n=document.getElementById("p_ical_url");if(!n)return;n.style.display="block",n.innerHTML=`
