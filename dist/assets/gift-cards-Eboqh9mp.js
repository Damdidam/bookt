import{a as p,d as D,G as a,s as I,k as m,l as w}from"./dashboard-BP1Shkdt.js";import{i as R,s as G}from"./plan-gate-Badg7tzn.js";import{f as c}from"./format-DoZVPAsZ.js";let g="all",x="",b=[],$=null,E=0,y={};function l(o){return String(o||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}let h=!0;async function f(){if(!R()){G(document.getElementById("contentArea"),"Cartes cadeau");return}const o=document.getElementById("contentArea");o.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{const e=new URLSearchParams;g!=="all"&&e.set("status",g),x.trim()&&e.set("search",x.trim());const t=await p.get(`/api/gift-cards?${e}`),r=t.gift_cards||[];b=r,h=t.feature_enabled!==!1;const n=t.stats||{};S(o,r,n)}catch(e){o.innerHTML=`<div class="empty" style="color:var(--red)">Erreur: ${l(e.message)}</div>`}}function S(o,e,t){e=e||b,t=t||{};let r="";h||(r+=`<div class="card" style="padding:14px 18px;margin-bottom:14px;background:#FFF8E1;border-left:4px solid #F9A825">
