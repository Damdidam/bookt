...
function fsShowActionBar() {
  ...
  bar.innerHTML = `
    <div class="fs-action-left">
      ...
      <span class="fs-lock-badge" id="fsLockBadge" style="display:none"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></span>
    </div>
    <div class="fs-action-right">
      ...
      <button class="btn-outline btn-sm" id="fsLockBtn" onclick="fsToggleLock()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px;vertical-align:middle;margin-right:2px"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> Verrouiller</button>
    </div>
  `;
...
function fsUpdateLockButton() {
  ...
  if (btn) {
    const lockSvg = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px;vertical-align:middle;margin-right:2px">';
    if (fsWeekLocked) {
      btn.innerHTML = lockSvg + '<rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 5-5a5 5 0 0 1 5 5"/></svg> Déverrouiller';
      btn.classList.add('fs-locked');
    } else {
      btn.innerHTML = lockSvg + '<rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> Verrouiller';
