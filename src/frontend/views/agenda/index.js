...
async function loadAgenda() {
  ...
  const initView = mobile ? 'resourceTimeGridDay' : 'resourceTimeGridWeek';
  ...
  toolbar += `<div class="at-row-nav"><div class="at-nav"><button class="at-nav-btn" onclick="atNav('prev')">\u2039</button><button class="at-today" onclick="atNav('today')">Aujourd'hui</button><button class="at-nav-btn" onclick="atNav('next')">\u203a</button></div><span class="at-title" id="atTitle"></span><div class="at-views"><button class="at-view-btn" data-view="resourceTimeGridDay" onclick="atView('resourceTimeGridDay')">Jour</button><button class="at-view-btn${initView === 'resourceTimeGridWeek' ? ' active' : ''}" data-view="resourceTimeGridWeek" onclick="atView('resourceTimeGridWeek')">Semaine</button><button class="at-view-btn" data-view="dayGridMonth" onclick="atView('dayGridMonth')">Mois</button>${fsBtnHtml}</div><span class="at-date" id="atDate"></span></div>`;
