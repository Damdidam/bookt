...
function openGalleryModal(item){
  ...
  ov.innerHTML=`<div class="m-dialog m-md">
    <div class="m-header-simple"><h3>${isEdit?'Modifier la photo':'Ajouter une photo'}</h3><button class="m-close" onclick="closeModal('galModal')"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div>
    <div class="m-body">
      <div>
...
function openNewsModal(item){
  ...
  ov.innerHTML=`<div class="m-dialog m-md">
    <div class="m-header-simple"><h3>${isEdit?'Modifier l\'article':'Publier un article'}</h3><button class="m-close" onclick="closeModal('newsModal')"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div>
    <div class="m-body">
...
function openTestimonialModal(item){
  ...
  ov.innerHTML=`<div class="m-dialog m-md">
    <div class="m-header-simple"><h3>${isEdit?'Modifier le témoignage':'Ajouter un témoignage'}</h3><button class="m-close" onclick="closeModal('testModal')"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div>
    <div class="m-body">
...
function openValueModal(item){
  ...
  ov.innerHTML=`<div class="m-dialog m-sm">
    <div class="m-header-simple"><h3>${isEdit?'Modifier la valeur':'Ajouter une valeur'}</h3><button class="m-close" onclick="closeModal('valModal')"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div>
    <div class="m-body">
