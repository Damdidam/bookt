    ...
    if(deps.length===0){
      ...
      deps.forEach(d=>{
        ...
        h+=`<tr style="border-bottom:1px solid var(--border-light)">
          ...
          <td style="padding:10px;text-align:center"><span style="font-size:.72rem;padding:3px 10px;border-radius:10px;background:${dc}12;color:${dc};font-weight:600">${esc(depStatusLabels[d.deposit_status]||d.deposit_status||'\u2014')}</span></td>
          ...
          <td style="padding:10px;text-align:center"><span style="font-size:.72rem;padding:3px 10px;border-radius:10px;background:${bc}12;color:${bc};font-weight:600">${esc(bkStatusLabels[d.booking_status]||d.booking_status)}</span></td>
