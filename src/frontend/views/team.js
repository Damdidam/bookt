      ...
      practs.forEach(p=>{
        ...
        h+=`<div class="team-member${p.is_active?'':' inactive'}">
          ...
          <div class="tm-badges">
            ...
            ${p.featured_enabled?`<span class="tm-badge" style="background:#FEF3C7;color:#92400E"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:10px;height:10px"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> Vedette</span>`:''}
...
function renderPractModal(p){
  ...
  let m=`<div class="modal-overlay" onclick="if(event.target===this)this.remove()"><div class="modal"><div class="modal-h"><h3>${isEdit?'Modifier':'Nouveau '+pracLbl}</h3><button class="close" onclick="this.closest('.modal-overlay').remove()"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div><div class="modal-body">
    ...
    <div class="field"><label style="display:flex;align-items:center;gap:8px"><input type="checkbox" id="p_featured" ${p?.featured_enabled?'checked':''}> <svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px;color:#D97706"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> Mode vedette</label><span style="font-size:.7rem;color:var(--text-4)">Permet de sélectionner et verrouiller des créneaux vedettes pour ce praticien</span></div>
