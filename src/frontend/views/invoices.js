      ...
      inv.forEach(f=>{
        ...
        h+=`<tr style="border-bottom:1px solid var(--border-light)">
          ...
          <td style="padding:10px;text-align:right">
            ...
            ${(f.type==='invoice'&&['sent','paid','overdue'].includes(f.status))?`<button onclick="issueCreditNote('${f.id}','${escJs(f.invoice_number||'')}')" title="Émettre une note de crédit (conformité BE)" aria-label="Émettre une note de crédit (conformité BE)" style="background:none;border:none;cursor:pointer;font-size:1rem;color:var(--gold)"><svg class="gi" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/></svg></button>`:''}
