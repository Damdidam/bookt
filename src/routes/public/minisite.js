  ...
  try {
    ...
    const _msResponse = {
      business: {
        ...
        last_minute_enabled: (biz.plan || 'free') !== 'free' && !!biz.settings?.last_minute_enabled,
        last_minute_discount_pct: (biz.plan || 'free') !== 'free' ? (biz.settings?.last_minute_discount_pct || 0) : 0,
