      ...
      try {
        ...
        if (bkData.rows.length > 0 && bkData.rows[0].client_email) {
          ...
          sendDepositPaidEmail({
            booking: d,
            business: { id: bk.business_id, name: d.business_name, email: d.business_email, phone: d.business_phone, address: d.business_address, theme: d.theme, slug: d.slug, settings: d.business_settings },
            groupServices
          }).catch(e => console.warn('[DEPOSIT VERIFY] Email error:', e.message));
          sendDepositPaidProEmail({
            booking: d,
            business: { id: bk.business_id, name: d.business_name, email: d.business_email, theme: d.theme }
